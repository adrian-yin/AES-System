...
class wenmind_score:
    def __init__(self, dict_word_level_path):
        ...
        self.nlp = StanfordCoreNLP(
            'https://corenlp.wenmind.net', port=443, lang='zh')
    ...
    def ssplit_tokenize_paragraph(self, paragraph):
        props = {'annotators': 'tokenize,ssplit', 'pipelineLanguage': 'zh'}

        # essay = '我叫张天佐。我叫张天佐。'
        text = self.nlp.annotate(paragraph, properties=props)
        # print(text)
        ...
        for i, sent in enumerate(text["sentences"]):
            ...
            for word in sent["tokens"]:
                sentenceArray.append(word["word"])
